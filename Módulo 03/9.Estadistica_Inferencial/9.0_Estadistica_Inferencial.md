...
### Imagen de la Distribución Exponencial

Voy a generar una imagen que represente la distribución exponencial con \(\lambda = 2\).
...
---
Aquí tienes la información en formato Markdown con emoticonos:
...
1. **👈 Sesgo a la Izquierda (Negativo):**
   ...
   ![Distribución Sesgada a la Izquierda](https://github.com/MabelMaff/Apuntes_Adalab/blob/main/M%C3%B3dulo%2003/9.Estadistica_Inferencial/Imagenes/skewed_distributions.png)
...
2. **📈 Distribución Simétrica (Normal):**
   ...
   ![Distribución Normal](https://github.com/MabelMaff/Apuntes_Adalab/blob/main/M%C3%B3dulo%2003/9.Estadistica_Inferencial/Imagenes/skewed_distributions.png)
...
3. **👉 Sesgo a la Derecha (Positivo):**
   ...
   ![Distribución Sesgada a la Derecha](https://github.com/MabelMaff/Apuntes_Adalab/blob/main/M%C3%B3dulo%2003/9.Estadistica_Inferencial/Imagenes/skewed_distributions.png)
...
plt.savefig('/mnt/data/skewed_distributions_with_mean_median.png')
...
![Distribuciones Sesgadas con Media y Mediana](sandbox:/mnt/data/skewed_distributions_with_mean_median.png)

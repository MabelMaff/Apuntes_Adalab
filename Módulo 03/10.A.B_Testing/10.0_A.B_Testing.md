...
| Independencia de Datos   | Revisión visual de datos               | Asegurarse de que las observaciones sean independientes |
...
- [Flujo de Trabajo del A/B Testing](https://github.com/MabelMaff/Apuntes_Adalab/blob/main/M%C3%B3dulo%2003/10.A_B_Testing/modulo-3-leccion-10-01-a-b-testing-flujo-trabajo.ipynb)
  > 📌 **Nota:** Este Jupyter es material adicional, no hace falta leerlo en la clase invertida.

- [Otros Test de A/B Testing](https://github.com/MabelMaff/Apuntes_Adalab/blob/main/M%C3%B3dulo%2003/10.A_B_Testing/modulo-3-leccion-10-a-b-testing-otros-test.ipynb)

---

## 📊 **Los Datos** 📊

- [Control Group CSV](https://github.com/MabelMaff/Apuntes_Adalab/blob/main/M%C3%B3dulo%2003/10.A_B_Testing/control_group.csv)
- [Test Group CSV](https://github.com/MabelMaff/Apuntes_Adalab/blob/main/M%C3%B3dulo%2003/10.A_B_Testing/test_group.csv)
...
Esta lección te proporcionará las herramientas y conocimientos necesarios para llevar a cabo A/B Testing de manera efectiva, permitiéndote optimizar continuamente tus estrategias y tomar decisiones basadas en datos. ¡Sigue practicando y experimentando para mejorar tus habilidades en A/B Testing!